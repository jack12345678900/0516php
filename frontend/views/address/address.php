...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            <h3>收货地址薄</h3>
            <dl  >
                <?php foreach ($addresss as $addres):?>
                <dt data-id="<?=$addres->id;?>">
                    <?= $addres->id;?>&emsp;
                   <?= $addres->name;?>&emsp;
                    <?= $addres->s_province;?>&emsp;
                    <?= $addres->s_city;?>&emsp;
                    <?= $addres->s_county;?>&emsp;
                   <?= $addres->area;?>&emsp;
                   <?= $addres->tel;?>
                </dt>

                <dd>
                    <a href="<?=\yii\helpers\Url::to(['address/edit','id'=>$addres->id])?>" class="btn btn-link"> <span class="glyphicon glyphicon-pencil" aria-hidden="true">修改</span></a>
                    <a href="<?=\yii\helpers\Url::to(['address/del','id'=>$addres->id])?>" class="btn btn-link"><span class="glyphicon glyphicon-trash" aria-hidden="true">删除</span></a>
                    <a href="">设为默认地址</a>
                </dd>
                <?php endforeach;?>
            </dl>
        ...
        <div class="address_bd mt10">
            <h4>新增收货地址</h4>
            <form action="" name="address_form" method="post" id="signupForm">
                <ul>
                    <li>
                   ...
                   <label for="" ><span>*</span>所在地区：</label>
                    ...
                    <li>
                        ...
                        <input type="text" name="area" class="txt address"  />
                    </li>
                    <li>
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox" name="remember" class="check" />设为默认地址
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
<script type="text/javascript">
    ...
    //Gid('s_city').setAttribute('onchange','showArea()');
  // createAddress('s_province', 's_city', 's_county');
...
//  */
////注册js代码
//$del_url=\yii\helpers\Url::to(['address/del']);
