		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php foreach ($good as $goodss):?>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/',largeimage: 'images/1.jpg'}"><img src="<?='http://admin.yii2shop.com'.$goodss->path?>"></a>
								</li>
                                <?php endforeach;?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?=\yii\helpers\Url::to(['shop/addtocart'])?>" method="get" class="choose">
						<ul>
