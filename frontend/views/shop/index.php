...
<div class="header w1210 bc mt15">
                ...
                <dd>
                    ...
                    <div class="uclist mt10">
                        <ul class="list1 fl">
                            <li><a href="">用户信息></a></li>
                            <li><a href="">我的订单></a></li>
                            <li><a href="http://www.yii2shop.com/address/address.html">收货地址></a></li>
                            <li><a href="">我的收藏></a></li>
                        </ul>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                 <?php foreach ($shop as $i=>$shop1):?>
                <div class="cat <?=$i?'':'item1'?>">
                    <h3><a href="<?=\yii\helpers\Url::to(['shop/list','category_id'=>$shop1->id])?>"><?=$shop1->name?></a><b></b></h3>
                    <div class="cat_detail">

              <?php foreach ($shop1->children(1)->all() as $k=>$shop2):?>
                        <dl <?=$k?'':'class="dl_lst"'?>>
                            <dt><a href="<?=\yii\helpers\Url::to(['shop/list','category_id'=>$shop2->id])?>"><?=$shop2->name?></a></dt>
                            <dd>
                                <?php foreach ($shop2->children()->all() as $shop3):?>
                                <a href="<?=\yii\helpers\Url::to(['shop/list','category_id'=>$shop3->id])?>"><?=$shop3->name?></a>
                      <?php endforeach;?>
                            </dd>
                        </dl>
                         <?php endforeach;?>
